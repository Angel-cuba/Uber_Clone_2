export const food = [
	{
		title: 'Lasagna',
		description:
			'Lasagna is a wide, flat pasta noodle, usually baked in layers in the oven. Like most Italian dishes, its origins are hotly contested. ',
		price: '£14.95',
	...
	},
	{
		title: 'Tacos',
		description:
			'Authentic Mexican food is vibrant, delicious, fresh and fun. ... Mexican cooking is packed with flavour ',
		price: '£22.30',
		image: 'https://res.cloudinary.com/dqaerysgb/image/upload/v1635360680/mexico_h9dcjv.jpg',
	},
	{
		title: 'Tandoori Kitchen',
		description: 'Indian cuisine is one of the most popular diverse on the planet. ',
		price: '£17.60',
